...
// 设置两个顶点组，形成两个材质
geometry.addGroup(0, 3, 0)  // 从0开始，三个顶点，材质1
...
const cubeMaterial4 = new THREE.MeshBasicMaterial({ color: 0xf0f000 })
const cubeMaterial5 = new THREE.MeshBasicMaterial({ color: 0x0f0f00 })
const cubeMaterial6 = new THREE.MeshBasicMaterial({ color: 0x00f0f0 })
