...
// planeMaterialCon.friction = 0.7;  // 摩擦
// planeMaterialCon.restitution = 1; // 弹性
...
// 定义接触材质
const boxMaterial1ToPlane = new CANNON.ContactMaterial(
  boxMaterialCon1,
  planeMaterialCon,
  {
    friction: 0,
...
world.addContactMaterial(boxMaterial1ToPlane)

const boxMaterial2ToPlane = new CANNON.ContactMaterial(
  boxMaterialCon2,
  planeMaterialCon,
  {
    friction: 0,
...
world.addContactMaterial(boxMaterial2ToPlane)
