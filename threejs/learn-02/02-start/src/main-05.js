...
exrLoader.load("./texture/opt/memorial/Alex_Hart-Nature_Lab_Bones_2k.exr", envMap => {
  envMap.mapping = THREE.EquirectangularReflectionMapping
  scene.environment = envMap
  scene.background = envMap
  plane.material.map = envMap
...
logLuvLoader.load("./texture/opt/memorial/memorial.tif", envMap => {
  scene.environment = envMap
  scene.background = envMap
  plane.material.map = envMap
  plane.material.needsUpdate = true
...
rgbmLoader.load("./texture/opt/memorial/memorial.png", envMap => {
  scene.environment = envMap
  scene.background = envMap
  plane.material.map = envMap
  plane.material.needsUpdate = true
